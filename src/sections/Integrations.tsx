        ...
        <section className="py-24 overflow-hidden">
            <div className="container">
               ...
               <p className="text-white/50 mt-4 text-lg">
                Layers seamlessly connect with your favourite tools and connect with your workflow across platforms.
               </p>
                 </div>
                 <div>               
               <div className="h-[400px] lg:h-[800px] mt-8 lg:mt-0 overflow-hidden grid md:grid-cols-2 gap-4 [mask-image:linear-gradient(to_bottom, transparent, black_10%, black_90%, transparent)]">

               <IntegrationColumn integrations={integrations}></IntegrationColumn>
               <IntegrationColumn integrations={integrations.slice().reverse()} className="hidden md:flex"></IntegrationColumn>
